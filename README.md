...
I adapted the project from this link [How to Create a Todo List with Phoenix LiveView](https://dennisbeatty.com/how-to-create-a-todo-list-with-phoenix-liveview.html). But I added the style further by using HTML and CSS. I am a total beginner in Phoenix framework so I complemented it with my basic existing skills in HTML and CSS.
